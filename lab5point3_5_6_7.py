...
def log_in_log_out():
    ...
    user_input = input("Do you want to log in (1) or log out (2) or exit (3)?\n")
    
    while user_input != '3':

        if user_input == '1':
            print("You are in the log in page.")
            if log_in is True:
                ...
                if choice == 1:
                    ...
                    for row in iter(cursor.fetchone, None):
                        ...
                        log_in = True
                    if not log_in: print("Email not found.")
...
# adding INSTRUCTOR COLUMN to the COURSE table
# sql_command = """ALTER TABLE COURSE
# ADD COLUMN INSTRUCTOR TEXT;"""
# cursor.execute(sql_command)

# sql_command = """UPDATE COURSE
# SET INSTRUCTOR = 'Jones Yu'
# WHERE CRN = 23300;"""
# cursor.execute(sql_command)
...
if user_input == 1:
    ...
    search_specific_courses()
>>>>>>> f47a318a6d212b6386bc6993f84d4b651449a7b7:lab5point3_5_6_7.py
database.commit()
database.close()
